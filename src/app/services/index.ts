...
export {useEntradaService} from './entrada.service'
export {useOrcamentoService } from './orcamento.service'
export {useMotorService} from './motor.service'
export {useCambioService} from './cambio.service'